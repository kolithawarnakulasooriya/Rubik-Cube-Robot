...
void setup() {
  ...
  stepperMotor1.setSpeed(600);//200
  pinMode(48,OUTPUT);
  pinMode(49,OUTPUT);
  stepperMotor2.setSpeed(600);
  pinMode(52,OUTPUT);
  pinMode(53,OUTPUT);
  stepperMotor3.setSpeed(600);
  pinMode(51,OUTPUT);
  pinMode(50,OUTPUT);
  stepperMotor4.setSpeed(600);
  pinMode(46,OUTPUT);
  pinMode(47,OUTPUT);
  Serial.begin(9600);
